	...
	<div class="card mb-4 shadow">
		...
		<div class="card-body pt-0 row">
			...
			<div class="col-10 col-md-7 col-lg-4 mx-auto my-2 mt-lg-5 row">
				<a class="btn btn-secondary text-success btn-lg active mx-auto p-2 px-4 w-100 placeBtn" role="button" aria-pressed="true" style="letter-spacing: 2px; font-size: 120%">Basic</a>
			</div>
			<div class="col-10 col-md-7 col-lg-4 mx-auto my-2 mt-lg-5 row">
				<a class="btn btn-secondar
				text-danger btn-lg active mx-auto p-2 px-4 w-100 eventBtn" role="button" aria-pressed="true">Advanced</a>
			</div>
		</div>
	</div>
